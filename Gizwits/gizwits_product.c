...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
  ...
  for(i=0; i<info->num; i++)
  {
    ...
    {
      case EVENT_LED_Flag:
        currentDataPoint.valueLED_Flag = dataPointPtr->valueLED_Flag;
        GIZWITS_LOG("Evt: EVENT_LED_Flag %d \n", currentDataPoint.valueLED_Flag);
        if(0x01 == currentDataPoint.valueLED_Flag)
        {
          //user handle
        }
        else
...
{
 /*
    currentDataPoint.valueFire_flag = ;//Add Sensor Data Collection
    currentDataPoint.valuePeople_flag = ;//Add Sensor Data Collection
    currentDataPoint.valueTemp = ;//Add Sensor Data Collection
    currentDataPoint.valueHum = ;//Add Sensor Data Collection
    currentDataPoint.valueAlarm_Light = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      ...
      currentDataPoint.valuePeople_flag = ;
      currentDataPoint.valueTemp = ;
      currentDataPoint.valueHum = ;
      currentDataPoint.valueAlarm_Light = ;
    */
