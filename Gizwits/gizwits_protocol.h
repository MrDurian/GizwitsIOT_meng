...
* @{
*/
#define PRODUCT_KEY "4579447a5efe4c2da7563af6f6c912a5"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "2b97b4404fff48d2a322d5b1c8694be4"
...
* @{
*/
#define LED_Flag_BYTEOFFSET                    0
#define LED_Flag_BITOFFSET                     0
#define LED_Flag_LEN                           1
#define Alarm_Light_BYTEOFFSET                    5
#define Alarm_Light_BITOFFSET                     0
#define Alarm_Light_LEN                           1

#define Fire_flag_RATIO                         1
#define Fire_flag_ADDITION                      0
#define Fire_flag_MIN                           0
#define Fire_flag_MAX                           10
#define People_flag_RATIO                         1
#define People_flag_ADDITION                      0
#define People_flag_MIN                           0
#define People_flag_MAX                           10
#define Temp_RATIO                         1
...
typedef struct {
  bool valueLED_Flag;
  uint32_t valueFire_flag;
  uint32_t valuePeople_flag;
  int32_t valueTemp;
  uint32_t valueHum;
  bool valueAlarm_Light;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagLED_Flag:1;
} attrFlags_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueFire_flag;
  uint8_t valuePeople_flag;
  uint8_t valueTemp;
  uint8_t valueHum;
